...
| 2025-11-22T14:00:00Z | Core schema | Desk review: Experiment/Job lifecycle helpers, DatasetRef stability, and audit/module metadata helpers instantiated and serialized via `to_dict()`. | Manual instantiation + `python - <<'PY'` snippets |
