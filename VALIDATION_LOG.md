...
| 2025-11-22T16:30:00Z | Testing & Validation | Added optional Streamlit stubs + sys.path bootstrap so `python -m unittest` (12 tests) now passes in clean envs without installing Streamlit. | `python -m unittest` terminal log |
